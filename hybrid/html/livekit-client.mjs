...
}]), je = /* @__PURE__ */ g.makeEnum("livekit.VideoQuality", [{
  no: 0,
  name: "LOW"
}, {
  no: 1,
...
var qi = { exports: {} }, Ge = typeof Reflect == "object" ? Reflect : null, vn = Ge && typeof Ge.apply == "function" ? Ge.apply : function(e, t, n) {
...
var vr = gr.exports;
const He = /* @__PURE__ */ oo(vr), Io = /* @__PURE__ */ Br({
  __proto__: null,
  default: He
}, [vr]);
function _t(i) {
  ...
  i.RTCIceCandidate = function(n) {
    if (typeof n == "object" && n.candidate && n.candidate.indexOf("a=") === 0 && (n = JSON.parse(JSON.stringify(n)), n.candidate = n.candidate.substring(2)), n.candidate && n.candidate.length) {
      const s = new e(n), r = He.parseCandidate(n.candidate);
      for (const a in r)
...
function ki(i) {
  !i.RTCIceCandidate || i.RTCIceCandidate && "relayProtocol" in i.RTCIceCandidate.prototype || _e(i, "icecandidate", (e) => {
    if (e.candidate) {
      const t = He.parseCandidate(e.candidate.candidate);
...
function Lt(i, e) {
  ...
  const t = function(o) {
    if (!o || !o.sdp)
      return !1;
    const c = He.splitSections(o.sdp);
    return c.shift(), c.some((d) => {
      const l = He.parseMLine(d);
    ...
    const l = He.matchPrefix(o.sdp, "a=max-message-size:");
...
const Qo = 5e3, it = [];
var Q = ((i) => (i[i.LOW = je.LOW] = "LOW", i[i.MEDIUM = je.MEDIUM] = "MEDIUM", i[i.HIGH = je.HIGH] = "HIGH", i))(Q || {});
  ...
  detach(e) {
    try {
      ...
      return this.attachedElements.forEach((n) => {
        ze(this.mediaStreamTrack, n), t.push(n), this.recycleElement(n), this.emit(T.ElementDetached, n);
    ...
    try {
      ...
      if (Ve(this._mediaStreamTrack, this.processorElement), this.processorElement.muted = !0, this.processorElement.play().catch((o) => this.log.error("failed to play processor element", h(h({}, this.logContext), {}, {
        ...
        for (const o of this.attachedElements)
          o !== this.processorElement && t && (ze(this._mediaStreamTrack, o), Ve(this.processor.processedTrack, o));
...
class An extends Pe.EventEmitter {
  constructor(e) {
    ...
    super(), this.log = I, this.pendingCandidates = [], this.restartingIce = !1, this.renegotiate = !1, this.trackBitrates = [], this.remoteStereoMids = [], this.remoteNackMids = [], this.negotiate = Gi(async (s) => {
      this.emit(We.NegotiationStarted);
      try {
  ...
  async setRemoteDescription(e) {
    ...
    }), this.pendingCandidates = [], this.restartingIce = !1, this.renegotiate ? (this.renegotiate = !1, await this.createAndSendOffer()) : e.type === "answer" && (this.emit(We.NegotiationComplete), e.sdp && ot(e.sdp).media.forEach((r) => {
      r.type === "video" && this.emit(We.RTPVideoPayloadTypes, r.rtp);
    }));
  }
...
class _c {
  ...
  async negotiate(e) {
    return new Promise(async (t, n) => {
      ...
      e.signal.addEventListener("abort", r), this.publisher.once(We.NegotiationStarted, () => {
        e.signal.aborted || this.publisher.once(We.NegotiationComplete, () => {
          clearTimeout(s), t();
        });
...
class Hc extends Pe.EventEmitter {
  ...
  async negotiate() {
    return new Promise(async (e, t) => {
      ...
      this.isClosed && t("cannot negotiate on closed engine"), this.on(P.Closing, s), this.pcManager.publisher.once(We.RTPVideoPayloadTypes, (r) => {
...
class pt extends Dr {
  ...
  setMuted(e) {
    super.setMuted(e), this.attachedElements.forEach((t) => {
      e ? ze(this._mediaStreamTrack, t) : Ve(this._mediaStreamTrack, t);
    });
  }
  attach(e) {
...
class he extends Pe.EventEmitter {
   ...
   */
  get videoTrack() {
    if (this.track instanceof Z || this.track instanceof pt)
      return this.track;
  }
  /** @internal */
  updateInfo(e) {
...
class Lr extends he {
  ...
  setVideoDimensions(e) {
    var t, n;
    this.isManualOperationAllowed() && (((t = this.videoDimensions) === null || t === void 0 ? void 0 : t.width) === e.width && ((n = this.videoDimensions) === null || n === void 0 ? void 0 : n.height) === e.height || (this.track instanceof pt && (this.videoDimensions = e), this.currentVideoQuality = void 0, this.emitTrackUpdate()));
  }
  setVideoFPS(e) {
    this.isManualOperationAllowed() && this.track instanceof pt && this.fps !== e && (this.fps = e, this.emitTrackUpdate());
  }
  get videoQuality() {
  ...
  get isAdaptiveStream() {
    return this.track instanceof pt && this.track.isAdaptiveStream;
  }
  /* @internal */
  emitTrackUpdate() {
    const e = new bs({
...
class $e extends _r {
  ...
  addSubscribedMediaTrack(e, t, n, s, r, a) {
    ...
    let d;
    return c ? d = new pt(e, t, s, r) : d = new ht(e, t, s, this.audioContext, this.audioOutput), d.source = o.source, d.isMuted = o.isMuted, d.setMediaStream(n), d.start(), o.setTrack(d), this.volumeMap.has(o.source) && d instanceof ht && d.setVolume(this.volumeMap.get(o.source)), o;
  }
  /** @internal */
  get hasMetadata() {
...
class Ar extends Pe.EventEmitter {
  ...
  constructor(e) {
    ...
    }, this.setMaxListeners(100), this.remoteParticipants = /* @__PURE__ */ new Map(), this.sidToIdentity = /* @__PURE__ */ new Map(), this.options = h(h({}, Dc), e), this.log = ve((n = this.options.loggerName) !== null && n !== void 0 ? n : de.Room), this.options.audioCaptureDefaults = h(h({}, xc), e == null ? void 0 : e.audioCaptureDefaults), this.options.videoCaptureDefaults = h(h({}, Mc), e == null ? void 0 : e.videoCaptureDefaults), this.options.publishDefaults = h(h({}, Ic), e == null ? void 0 : e.publishDefaults), this.maybeCreateEngine(), this.disconnectLock = new ne(), this.localParticipant = new qe("", "", this.engine, this.options), this.options.videoCaptureDefaults.deviceId && this.localParticipant.activeDeviceMap.set("videoinput", Te(this.options.videoCaptureDefaults.deviceId)), this.options.audioCaptureDefaults.deviceId && this.localParticipant.activeDeviceMap.set("audioinput", Te(this.options.audioCaptureDefaults.deviceId)), (s = this.options.audioOutput) !== null && s !== void 0 && s.deviceId && this.switchActiveDevice("audiooutput", Te(this.options.audioOutput.deviceId)).catch((r) => this.log.warn("Could not set audio output: ".concat(r.message), this.logContext)), this.options.e2ee && this.setupE2EE();
  }
  /**
   * @experimental
   */
  ...
  setupE2EE() {
    if (this.options.e2ee) {
      ...
      this.e2eeManager = new pc(this.options.e2ee), this.e2eeManager.on(Ee.ParticipantEncryptionStatusChanged, (t, n) => {
        n instanceof qe && (this.isE2EEEnabled = t), this.emit(k.ParticipantEncryptionStatusChanged, t, n);
...
const $i = {
  connectWithFormInput: async () => {
    var i, e;
    const t = Hn("url"), n = Hn("token"), s = R("simulcast").checked, r = R("dynacast").checked, a = R("force-turn").checked, o = R("adaptive-stream").checked, c = R("publish-option").checked, d = R("preferred-codec").value, l = R("scalability-mode").value, u = R("auto-subscribe").checked, p = R("audio-output").value;
    lo(xs.debug);
    const f = {
      adaptiveStream: o,
      dynacast: r,
    ...
    }), await $i.connectToRoom(t, n, f, b, c), $.bitrateInterval = setInterval(td, 1e3);
  },
  connectToRoom: async (i, e, t, n, s) => {
    const r = new Ar(t);
    fe = Date.now(), await r.prepareConnection(i, e);
    const a = Date.now() - fe;
    D("prewarmed connection in ".concat(a, "ms")), r.on(k.ParticipantConnected, di).on(k.ParticipantDisconnected, Zc).on(k.DataReceived, Xc).on(k.Disconnected, ed).on(k.Reconnecting, () => D("Reconnecting to room")).on(k.Reconnected, async () => {
  ...
  flipVideo: () => {
    ...
    if (!t)
      return;
    $.isFrontFacing ? Ke("flip-video-button", "Front Camera", !1) : Ke("flip-video-button", "Back Camera", !1), $.isFrontFacing = !$.isFrontFacing;
    const n = {
      resolution: me.h720.resolution,
...
`), i.value = "";
  ...
  disconnectRoom: () => {
    E && E.disconnect(), $.bitrateInterval && clearInterval($.bitrateInterval), Yc.postMessage({
      type: "cancle"
    });
  },
  handleScenario: (i) => {
...
function ie(i) {
  ...
  if (!s && !e) {
    ...
    `), i instanceof qe ? (s.className = "participant participant-you", s.innerHTML = "<canves style='width:80px;height:100px'>" + s.innerHTML + "</canves>") : s.className = "participant participant-other", t.appendChild(s);
  ...
  R("name-".concat(n)).innerHTML = i.identity, i instanceof qe && (R("name-".concat(n)).innerHTML += " (you)");
...
function td() {
  ...
  for (const e of i) {
    ...
    let n = 0;
    for (const r of e.trackPublications.values())
      r.track && (n += r.track.currentBitrate);
    let s = "";
...
function we() {
  ...
  Ke("toggle-video-button", "".concat(i.isCameraEnabled ? "Disable" : "Enable", " Video"), i.isCameraEnabled), Ke("toggle-audio-button", "".concat(i.isMicrophoneEnabled ? "Disable" : "Enable", " Audio"), i.isMicrophoneEnabled), Ke("share-screen-button", i.isScreenShareEnabled ? "Stop Screen Share" : "Share Screen", i.isScreenShareEnabled), Ke("toggle-e2ee-button", "".concat(E.isE2EEEnabled ? "Disable" : "Enable", " E2EE"), E.isE2EEEnabled);
}
async function nd() {
  Yi();
}
